...
//Implementing Admin Users Dashboard
...
//Implementing Admin Delete Users action
export const userDeleteAction = (id) => async (dispatch, getState) =>{
  try {
    ...
    dispatch({
      ...
      payload: data //optional in this case
    })
...
//Implementing Admin Delete Users action
export const userProfUpdateByAdminAction = (id, user) => async (dispatch, getState) =>{
  try {
...
export const resetAdminUpdatedField =() =>(dispatch)=>{

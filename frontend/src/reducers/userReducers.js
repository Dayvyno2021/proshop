...
export const userLoginReducer = (state={}, action) =>{
  switch (action.type) {
    ...
    case USER_LOGIN_SUCCESS:
      return Object.assign({}, state, {loading: false, userInfo: action.payload})
...
export const userDetailsReducer = (state={user:{}}, action)=>{
  switch (action.type) {
    case USER_DETAILS_REQUEST:
      return {...state, loading:true}  // ...state to avoid running into trouble during loading
...
export const userProfUpdateByAdminReducer = (state={success:false}, action)=>{
  switch (action.type) {
